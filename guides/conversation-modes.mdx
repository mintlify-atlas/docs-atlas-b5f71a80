---
title: "How Larry Shifts Conversation Modes"
sidebarTitle: "Conversation Modes"
description: "MindrianOS routes every message through an intent classifier that sets the conversation mode — JUST_TALK, EXPLORE_CAPTURE, BUILD_ROOM, METHODOLOGY, or DECISION_GATE."
---
...
Selecting "none fit" routes you to `/mos:do` with your intent captured, so Larry can propose something else without losing what you were trying to accomplish.
