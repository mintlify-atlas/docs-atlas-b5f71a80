---
title: "Connect the Brain for Framework Intelligence"
sidebarTitle: "Brain Setup"
description: "The Brain is an optional Neo4j/Pinecone teaching graph that gives Larry framework chaining, semantic search, and calibrated grading. Set it up in two steps."
---
...
<Steps>
  <Step title="Drop your key in ~/.mindrian.env">
    ...
    ```bash
    echo "MINDRIAN_BRAIN_KEY=<your-key>" > ~/.mindrian.env && chmod 600 ~/.mindrian.env
    ```
