...
description: "/mos:suggest-next reads your room's problem type and active JTBD, then recommends the next framework chain and its /mos: commands via the Brain FEEDS_INTO graph."
---
...
shows two strong FEEDS_INTO edges from here:
  ...
  2. /mos:six-hats        [0.72 confidence]
...
── Next move ──────────────────────────────────────────
[/mos:analyze-needs]  [/mos:six-hats]  [/mos:minto]
...
<CardGroup cols={2}>
  ...
  <Card title="/mos:grade" href="/commands/grade">
    Score room quality — grade results feed suggest-next's room-state assessment.
  </Card>
</CardGroup>
