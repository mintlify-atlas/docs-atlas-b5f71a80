...
description: "/mos:find-connections queries the Brain graph for cross-domain connections — analogies, bridging frameworks, and surprising precedents from methodology."
---
...
<Steps>
  ...
  <Step title="Query immediate connections (Brain graph query)">
