...
description: "/mos:research pulls web evidence, cross-references with the Brain, and wires accepted findings as EvidenceClaim nodes — context-aware and room-scoped."
---
