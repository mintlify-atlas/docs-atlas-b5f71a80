...
description: "/mos:beautiful-question runs the Beautiful Question reframing methodology — Larry challenges your problem statement and surfaces the real problem beneath the stated one."
---
...
<Tip>
  The reframed problem statement becomes the anchor for downstream commands. `/mos:analyze-needs` and `/mos:jtbd` both read problem-definition entries to orient their analysis.
</Tip>
