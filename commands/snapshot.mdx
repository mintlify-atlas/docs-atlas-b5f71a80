---
title: "/mos:snapshot — Save the Current Room State"
sidebarTitle: "snapshot"
description: "/mos:snapshot packages your room into a shareable HTML export — a three-door lobby and a full museum. Use it before pivots or at venture milestones."
---

`/mos:snapshot` packages your Data Room into a shareable, self-contained export. It generates two files in one command: a three-door lobby (`index.html`) that adapts to what your room actually contains, and a full museum (`hub.html`) with every artifact across every section in a single file. The lobby is what you show someone first; the museum is the complete reference.
