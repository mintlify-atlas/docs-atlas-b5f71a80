---
title: "/mos:room — View, Launch, and Navigate the Data Room"
sidebarTitle: "Room"
description: "/mos:room opens the active Data Room view with its current state — the default entry point for navigation, section cards, and dashboard launch."
---
